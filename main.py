...
def get_user_input():
    """Get user input for trip planning preferences."""
    # Location input
    ...
    return start_location, companion_type, budget, starting_time, user_selected_types

# Get user input
start_location, companion_type, budget, starting_time, user_selected_types = get_user_input()
